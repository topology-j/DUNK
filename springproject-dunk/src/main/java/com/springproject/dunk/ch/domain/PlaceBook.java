package com.springproject.dunk.ch.domain;
...
public class PlaceBook {
	...
	public PlaceBook(int placeNo, Date dates, String timeBook) {
	...
	public PlaceBook(int no, int placeNo, String placeName, String placeAddress1, String placeAddress2, int placePay,
