						...
						<div class="col">
							<div class="bg-secondary bg-opacity-10 rounded-start rounded-end">
								<div class="row mx-3 py-3">
									<div class="col">
										<div class="row fw-bold border-bottom my-2 px-5" style="--bs-border-color: #E1E1E1">
											<div class="col-6">
												${t.name}
											</div>
											<div class="col-6 text-end">												
												<input type="button" class="btn btn-dark" value="선택" onclick="location.href='choiceTeamMatchUser?teamNo=${t.no}&bookNo=${bookNo}&tmNo=${tmNo}'" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">																					
											</div>
										</div>
